            ...
            <div className="container mx-auto px-6 max-w-2xl">
                ...
                <form onSubmit={handleSubmit} className="bg-black border border-white/10 p-10 rounded-3xl shadow-2xl relative overflow-hidden">
                    ...
                    <motion.button
                        ...
                        className="group relative w-full font-black py-5 rounded-2xl border border-white/10 mt-4 text-xs tracking-[0.2em] uppercase overflow-hidden disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center transition-colors duration-300 cursor-pointer hover:bg-white hover:text-black"
                    >
                        <motion.div
